...
const projects = [
  ...
  },
  {
    ...
    type: "Robotics",
    period: "2025",
    description: "Competition C++ codebase for the PushBack season using the JAR (Jackson Area Robotics) template framework. All VEX Pushback code is consolidated in a single repository: HABS-Gliders-Pushback-2526.",
    stack: ["C++", "JAR Template", "PID", "IMU"],
    status: "Complete",
    link: "https://github.com/PanshulVempalli/HABS-Gliders-Pushback-2526",
  },
  {
    title: "VEX V5 — Prematch Auton Example",
    type: "Robotics",
    period: "2025",
    description: "Open-source base autonomous routine for the VEX V5 Pushback season. Designed as a beginner-friendly starting point for teams building their first auton — no sensors or PID required. This project is included in the HABS-Gliders-Pushback-2526 repository.",
  ...
  },
  {
    ...
    type: "Robotics",
    period: "2025",
    description: "Foundational skills autonomous program for the Pushback season. Published as an educational resource for teams starting out with Python on VEX V5. This project is included in the HABS-Gliders-Pushback-2526 repository.",
...
const accolades = [
  {
    title: "Won Judges Award — VEX Worlds 2026",
    type: "Award",
    period: "2026",
    org: "VEX Robotics World Championship",
    detail: "Won the Judges Award at the 2026 VEX Robotics World Championship for outstanding design and team collaboration.",
    icon: "🏆",
  },
  {
    title: "VEX Worlds",
  ...
  },
  {
    ...
    period: "2026",
    org: "VEX Robotics World Championship",
    detail: "Received the Judges Award at a regional competition.",
    icon: "🏆",
  },
  {
