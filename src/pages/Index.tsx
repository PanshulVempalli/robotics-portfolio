...
const projects = [
  ...
  {
    title: "HABS-Gliders-Pushback-2526",
    type: "Robotics",
    period: "2025",
    description: "Consolidated VEX Pushback projects in a single repository. Includes the JAR template C++ competition code, VEX V5 prematch autonomous routine, and VEX V5 Python skills autonomous program — all developed for Habs Gliders Pushback 2526.",
    stack: ["C++", "Python", "VEX V5", "Robotics"],
    status: "Complete",
